...
public class Main
{
    public static final String text = "Item #: SCP-002\n" +
            "\n" +
            "Object Class: Euclid\n" +
            "\n" +
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("Number of words: " + info.getNrOfWords());
        System.out.println("Number of sentences: " + info.getNrOfSentences());
        System.out.println("Number of letters: " + info.getNrOfLetters());
        System.out.println("Number of vowels: " + info.getNrOfVowels());
        System.out.println("Number of consonants: " + info.getNrOfConsonants());
        System.out.println("Top 5 words: " + info.getTopWords(5));
        System.out.println("Longest word: "+ info.getLongestWord());
    }
}
